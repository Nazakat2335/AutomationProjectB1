...
public class T4_explicit_wait {
    ...
    public void test(){
        ...
        Assert.assertTrue(loopPracticeDynamicLoadingPage.doneMessage.isDisplayed(),"this message is not displayed");
        Assert.assertTrue(loopPracticeDynamicLoadingPage.image.isDisplayed(),"this image is not displayed");
    }
}
